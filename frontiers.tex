...
\def\Authors{Alfonso Antonio Flores\,$^{1,*}$, Julio Gonzales Huerta \,$^{2}$ y Marco Antonio Jimenez Morales\,$^{1,2}$}
...
$^{2}$Laboratorio de modelacion matematica,FCFM,BUAP,Puebla,Puebla  }
...
\section{}
aqui va un peqnio abtsract del trabajo
